...
namespace FORCEBuild.ORM
{
    ...
    public static class OrmConfig
    {
        ...
        public static Field GeField(string config)
        {
            ...
            var accessorScheduler = new AccessorDispatcher { Accessor = accessor };
            accessor.Scheduler = accessorScheduler;
        ...
        public static Field GetField(OrmRegister register)
        {
            ...
            var updateScheduler = new AccessorDispatcher {Accessor = accessor};
            accessor.Scheduler = updateScheduler;
