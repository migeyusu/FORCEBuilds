...
namespace FORCEBuild.UI.Winform.Feature
{
    ...
    /// win8下无法使用
    /// </summary>
    public static class AeroExtend
    {
        ...
        private static void Win10AeroEffectOn(IntPtr hwnd)
        {
        ...
        private static void Win10AeroEffectOff(IntPtr hwnd)
        {
            var ap = new AccentPolicy
            {
        ...
        public static void Win7AeroExtend(IntPtr hwd)
        {
            var en = 0;
            var x = -1;
            var mg = new Margins
            ...
            DwmExtendFrameIntoClientArea(hwd, ref mg);
        }

        private static void Win7AeroEffectOn(IntPtr hwnd)
        {
        ...
        private static void Win7AeroEffectOff(IntPtr hwnd)
        {
            var db = new DwmBlurbehind
            {
                fEnable = false,
        ...
        public static void AeroEffectOn(IntPtr hwnd)
        {
            ...
            if (os.Major == 6)
            {
                ...
                {
                    case 1:
                        Win7AeroEffectOn(hwnd);
                        return;
                    case 2:
                        Win10AeroEffectOn(hwnd);
                        return;
                }
            }
        ...
        public static void AeroEffectOff(IntPtr hwnd)
        {
            var os = Environment.OSVersion.Version;
            if (os.Major == 6)
            {
                ...
                {
                    case 1:
                        Win7AeroEffectOff(hwnd);
                        return;
                    case 2:
                        Win10AeroEffectOff(hwnd);
                        return;
                }
            }
            else if (os.Major == 10 && os.Minor == 0)
